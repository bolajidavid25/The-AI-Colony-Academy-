...
import iconTwo from "../assets/Why-Choose-TAACA/icon 2.png";
import iconThree from "../assets/Why-Choose-TAACA/icon-3.png";
import iconFour from "../assets/Why-Choose-TAACA/icon-4.png";

const iconOne = (
  <div className="flex h-14 w-14 items-center justify-center rounded-[5px] bg-[#00B98A]">
    <svg
      width="20"
      height="20"
      viewBox="0 0 20 20"
...
function IconBadge({ src, alt }: { src: typeof iconTwo; alt: string }) {
  return (
    <div className="flex h-14 w-14 items-center justify-center rounded-[5px] bg-[#00B98A]">
      <Image
        src={src}
...
const features = [
  {
    title: "AI Specific",
    description:
      "Not general tech, every course is built around AI tools applied to real work.",
    icon: iconOne,
  },
  {
    title: "Signed Certifcates",
    description:
      "Your certificate is signed by the founder, not auto-generated.",
    icon: <IconBadge src={iconTwo} alt="" />,
  },
  {
    title: "Cohort Based",
    description:
      "Not self-paced, you learn with a group, on a schedule, with live sessions. This is why our completion rate is 10x the industry average.",
    icon: <IconBadge src={iconThree} alt="" />,
  },
  {
    title: "African Native",
    description:
      "Globally relevant, built for the African market and diaspora, open to learners anywhere.",
    icon: <IconBadge src={iconFour} alt="" />,
  },
];
...
export default function WhyChooseUs() {
  return (
    <section
      ...
      className="relative w-full overflow-hidden bg-[#002B1F]"
    >
      <Image
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(0,43,31,0.94) 0%, rgba(0,43,31,0.82) 42%, rgba(0,43,31,0.68) 72%, rgba(0,43,31,0.52) 100%)",
        }}
      />

      {/* Glow blooming downward — mirrors the hero divider */}
      <div
        className="pointer-events-none absolute inset-x-0 top-0 z-[2] h-[90px]"
        style={{
          background:
            "linear-gradient(to bottom, rgba(49,202,146,0.5) 0%, rgba(49,202,146,0.18) 38%, transparent 100%)",
        }}
      />

      <div className="relative z-10 mx-auto w-full max-w-[1260px] px-6 pb-24 pt-20 lg:px-8 lg:pb-28 lg:pt-24">
        <header className="mx-auto mb-16 max-w-[720px] text-center">
          <h2
            id="why-choose-us-heading"
            className="mb-5 text-[38px] font-bold leading-[1.1] tracking-[-1.2px] text-white md:text-[42px]"
          >
            Why Choose Taaca ?
          </h2>
          <p className="mx-auto max-w-[620px] text-[15px] leading-relaxed text-white/55">
